...
Comment.create(post: first_post, author: second_user, text: 'Hi Tom! How are you?')
Comment.create(post: first_post, author: second_user, text: 'Hi Tom! Welcome')
Comment.create(post: first_post, author: second_user, text: 'see you tomorrrow')
Comment.create(post: first_post, author: first_user, text: 'I\'m new here' )
Comment.create(post: first_post, author: second_user, text: 'I hope you enjoy yourself here!' )
